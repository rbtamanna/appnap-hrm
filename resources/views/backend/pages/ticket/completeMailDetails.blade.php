<php>
    ...
    I am writing to let you know that the ticket I was assigned by you is done.<br>
    @if($ticket_info->remarks)Remarks for the ticket: {{$ticket_info->remarks}} <br> @endif<br>
