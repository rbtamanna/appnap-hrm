...
@endsection
@section('page_action')
    @if ($addMeetingPlacePermission)
    <div class="mt-3 mt-sm-0 ml-sm-3">
        <a href="{{ url('meeting_place/add') }}">
            <button type="button" class="btn btn-dark mr-1 mb-3">
                <i class="fa fa-fw fa-key mr-1"></i> Add Meeting Place
            </button>
        </a>
    </div>
    @endif
    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            <div class="block-header">
                <h3 class="block-title">Manage Meeting Places</h3>
            </div>
                            ...
                            <form id="change_status" action="" method="post">
                                ...
                                <div class="block block-rounded block-themed block-transparent mb-0">
                                    <div class="block-header bg-primary-dark">
                                        <h3 class="block-title text-center">Change Meeting Place Status</h3>
                                    ...
                                    <div class="block-content font-size-sm">
                                        ...
                                        <input type="hidden" name="meeting_place_id" id="meeting_place_id">
                                    </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form id="delete" action="" method="post">
                                ...
                                <div class="block block-rounded block-themed block-transparent mb-0">
                                    <div class="block-header bg-primary-dark">
                                        <h3 class="block-title text-center">Delete Meeting Place</h3>
                                        <div class="block-options">
                                            <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
                                                <i class="fa fa-fw fa-times"></i>
                                            </button>
                                    ...
                                    <div class="block-content font-size-sm">
                                        <p class="text-center"><span id="meeting_place_name"></span> Meeting place will be deleted. Are you sure?</p>
                                        <input type="hidden" name="delete_meeting_place_id" id="delete_meeting_place_id">
                                    </div>
                                    <div class="block-content block-content-full text-right border-top">
                                        <button type="button" class="btn btn-alt-primary mr-1" data-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-primary">Submit</button>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form id="restore" action="" method="post">
                                ...
                                <div class="block block-rounded block-themed block-transparent mb-0">
                                    <div class="block-header bg-primary-dark">
                                        <h3 class="block-title text-center">Restore Meeting Place</h3>
                                        <div class="block-options">
                                            <button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
                                                <i class="fa fa-fw fa-times"></i>
                                            </button>
                                    ...
                                    <div class="block-content font-size-sm">
                                        <p class="text-center"><span id="restore_meeting_place_name"></span> Meeting Place will be restored. Are you sure?</p>
                                        <input type="hidden" name="restore_meeting_place_id" id="restore_meeting_place_id">
                                    </div>
                                    <div class="block-content block-content-full text-right border-top">
                                        <button type="button" class="btn btn-alt-primary mr-1" data-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-primary">Submit</button>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function ($) {
            ...
            var dtable = $('#table').DataTable({
                responsive: true,
                ajax: '{{ url('meeting_place/get_meeting_place_data') }}',
                paging: true,
        ...
        function show_status_modal(id, msg) {
            ...
            const url = "{{ url('meeting_place/:id/change_status') }}".replace(':id', id);
            $('#change_status').attr('action', url);
            $('#status-modal').modal('show');
        }
        function show_delete_modal(id, name) {
            var x = document.getElementById('meeting_place_name');
            x.innerHTML = name;
            const url = "{{ url('meeting_place/:id/delete') }}".replace(':id', id);
            $('#delete').attr('action', url);
            $('#delete-modal').modal('show');
        }
        function show_restore_modal(id, name) {
            var x = document.getElementById('restore_meeting_place_name');
            x.innerHTML = name;
            const url = "{{ url('meeting_place/:id/restore') }}".replace(':id', id);
